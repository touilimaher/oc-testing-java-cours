...
public class CalculatorServiceTest {
	...
	public void calculate_shouldUseCalculator_forSubtraction() {
		...
		// WHEN
		final int result = classUnderTest.calculate(new CalculationModel(CalculationType.SUBTRACTION, 3, 2))
				.getSolution();
	...
	public void calculate_shouldUseCalculator_forMultiplication() {
		...
		// WHEN
		final int result = classUnderTest.calculate(new CalculationModel(CalculationType.MULTIPLICATION, 3, 2))
				.getSolution();
	...
	public void calculate_shouldUseCalculator_forDivision() {
		...
		// WHEN
		final int result = classUnderTest.calculate(new CalculationModel(CalculationType.DIVISION, 6, 2))
				.getSolution();
